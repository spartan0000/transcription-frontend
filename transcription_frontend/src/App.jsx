...
function draftToReportData(draft) {
  return {
    ...
    report: {
      ...
      terminal_ileum_intubated: draft.terminal_ileum_intubated,
      ileocecal_valve_identified: draft.ileocecal_valve_identified,
      appendiceal_orifice_identified: draft.appendiceal_orifice_identified,
      tripartite_fold_identified: draft.tripartite_fold_identified,
      other_landmarks_identified: draft.other_landmarks_identified,
      polyps: draft.polyps ?? [],
